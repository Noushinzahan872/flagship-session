        ...
        <div className='py-12'>
           ...
           <div className='text-center space-y-4'>
             ...
             <form onSubmit={e =>{
                ...
                type="text"
                 placeholder='Search phone by name' className='bg-white border border-gray-300 rounded shadow-md w-2/3 h-12 px-4 mb-3 focus:outline-none focus:shadow-outline md:mr-2 md:mb-0'/>
